import openLinkInSamePage from "@/utils/openLinkInSamePage";
    ...
    return (
        <div className="relative overflow-hidden shadow-lg" onClick={() => openLinkInSamePage("/eventos", router)}>
            ...
            <div className="absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 lg:w-1/2">
                ...
                <p className="lg:text-2xl text-xl text-[#A5A5A5] text-center  font-bold uppercase">Participe do emocionante torneio interclasse e mostre sua paixão pelo esporte</p>
            </div>
